...
handlers.request = function (req, res){
    ...
    switch (method){
        ...
        case 'POST': if(pathname === '/menu' || pathname === '/menu/' ){
                        handlers.add(file,query,(statusCode,resStr)=>{
                            res.setHeader('content-type','text/plain; charset="utf-8"');
        ...
        case'DELETE': if(pathname === '/menu' || pathname === '/menu/' ){
                        handlers.delete(file, query, (statusCode,resStr)=>{
                            res.setHeader('content-type','text/plain; charset="utf-8"');
                            res.writeHead(statusCode);
                            res.end(resStr);
                        });
        ...
        case 'PUT': if(pathname === '/menu' || pathname === '/menu/' ){
                        handlers.update(file, query,(statusCode,resStr)=>{
                            res.setHeader('content-type','text/plain; charset="utf-8"');
                            res.writeHead(statusCode);
                            res.end(resStr);
                        });
